...
[Package Managers Comparison: Yarn, NPM, PNPM](https://www.cookielab.io/blog/package-managers-comparison-yarn-npm-pnpm)<br />
[Package management basics - Learn web development | MDN](https://developer.mozilla.org/en-US/docs/Learn/Tools_and_testing/Understanding_client-side_tools/Package_management)<br />
...
[10 Best Front end Frameworks for Web Development in 2024](https://www.knowledgehut.com/blog/web-development/front-end-development-frameworks)<br />
...
이 외에도 많은 메타 data를 제공할 수 있다. 참고 ([Meta Tag , OG(오픈그래프) 사용하기](https://velog.io/@byeol4001/Meta-Tag-OG%EC%98%A4%ED%94%88%EA%B7%B8%EB%9E%98%ED%94%84-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0))

#### 참고자료

[head 태그에는 무엇이 있을까? HTML의 메타데이터 - Web 개발 학습하기 | MDN](https://developer.mozilla.org/ko/docs/Learn/HTML/Introduction_to_HTML/The_head_metadata_in_HTML)<br />
...
linting은 오류를 줄이고 코드의 전반적인 품질을 향상시키는 데 중요하다.<br />
이를 통해 소스 코드를 일관되게 유지하고 코드 검토를 향상시킬 수 있다.<br />
...
**Husky**: 코드를 커밋하거나 git에 코드를 푸시하기 전에 명령 또는 스크립트를 실행할 수 있는 사전 커밋 도구.<br />
**lint-staged**: Husky에 의해 커밋하기 전에 스테이징된 파일을 서식 지정하는 사전 커밋 스크립트로 실행될 수 있다.

[Husky 공식문서](https://typicode.github.io/husky/)<br />
[lint-staged GitHub 레포](https://github.com/lint-staged/lint-staged)

##### 참고

[Complete guide to ESLint, Prettier, husky and lint-staged](https://dev.to/shashwatnautiyal/complete-guide-to-eslint-prettier-husky-and-lint-staged-fh9)<br />
[Stylelint와 Husky](https://eonseok-blog.vercel.app/til-1/)
...
리액트는 파일/디렉토리 구조에 관해서 "옳은" 방법은 없다.<br />
지역성을 기준으로, 혹은 기능을 기준으로, 혹은 url을 기준으로 다양한 방법이 존재한다.<br />
