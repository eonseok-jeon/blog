---
title: '빌드 최적화 해보기'
subTitle: 'lottie-react 라이브러리 뜯어보기'
date: '2024-08-25'
tag: 'troubleshooting'
url: 'troubleshooting-7'
...
더 많은 option들은 [여기서](https://www.npmjs.com/package/rollup-plugin-visualizer#options) 볼 수 있다.
...
사이트는 [여기](https://www.lottiemizer.com/ko/)를 이용해줬다.
